...
describe("listLevels", () => {
  it("returns levels ordered by their order field", async () => {
    const levelRepository = new FakeLevelRepository([
      { id: "level-2", name: "Advanced", order: 3, description: null, parentLevelId: null, teacherId: null },
      { id: "level-1", name: "Beginner", order: 1, description: null, parentLevelId: null, teacherId: null },
      { id: "level-3", name: "Intermediate", order: 2, description: null, parentLevelId: null, teacherId: null },
    ]);
